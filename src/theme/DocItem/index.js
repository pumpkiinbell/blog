...
function DocItemContent(props) {
  ...
  useEffect(() => {
    (() => {
      ...
      script.setAttribute('repo', 'pumpkiinbell/blog');
      script.setAttribute('issue-term', 'https://github.com/pumpkiinbell/blog/issues');
      ...
      <div className={clsx('col', !hideTableOfContents && styles.docItemCol)}>
        ...
        <div className={styles.docItemContainer}>
          ...
          */}
          ...
          <div ref={containerRef} style={{ marginTop: '50px' }} />
        </div>
      </div>
      {renderTocDesktop && (
