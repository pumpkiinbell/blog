...
keywords: ['TypeScript', 'React', 'useRef', 'RefCallback', 'RefObject', '@types/react', 'Bivariance hack for consistent unsoundness with RefObject', 'bivarianceHack', '이변성', '공변성', '변성']
tags:
  - TypeScript
  - React
---
